...
#  GTSAM_INCLUDE_DIR - include directories for semantic_slam

# Compute paths
get_filename_component(OUR_CMAKE_DIR "${CMAKE_CURRENT_LIST_FILE}" PATH)
if(EXISTS "${OUR_CMAKE_DIR}/CMakeCache.txt")
  # In build tree
  set(GTSAM_INCLUDE_DIR /Users/ishitagoluguri/Desktop/MIT/UROP 2022/semantic_slam/lib/gtsam CACHE PATH "GTSAM include directory")
else()
